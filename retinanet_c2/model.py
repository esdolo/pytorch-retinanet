...
from retinanet_c2.utils import BasicBlock, Bottleneck, BBoxTransform, ClipBoxes
from retinanet_c2.anchors import Anchors
from retinanet_c2 import losses
...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes, block, layers):
        ...
        if block == BasicBlock:
            ...
            fpn_sizes = [self.layer1[layers[0] - 1].conv2.out_channels,self.layer2[layers[1] - 1].conv3.out_channels, self.layer3[layers[2] - 1].conv3.out_channels,
