...
from retinanet_c2 import model
from retinanet_c2.dataloader import CocoDataset, CSVDataset, collater, Resizer, AspectRatioBasedSampler, Augmenter, \
    Normalizer
from torch.utils.data import DataLoader

from retinanet_c2 import coco_eval
from retinanet_c2 import csv_eval
...
def main(args=None):
    ...
    for epoch_num in range(parser.epochs):
        ...
        if epoch_num%10==0:
            torch.save(retinanet.module, './models/{}_retinanet_c2{}_ADAM_{}.pt'.format(parser.dataset, parser.depth,epoch_num+epochpassed))

    #retinanet.eval()

    torch.save(retinanet.module, './models/{}_retinanet_c2{}_ADAM_{}.pt'.format(parser.dataset, parser.depth,parser.epochs+epochpassed))
    writer.close()
